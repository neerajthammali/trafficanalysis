...
export default function InfoPage() {
    return (
        <main className="flex-grow container mx-auto px-4 py-8 sm:px-6 lg:px-8">
            ...
            <article className="prose prose-lg dark:prose-invert max-w-4xl mx-auto space-y-6">
                <div>
                    <h2 className="font-headline text-2xl text-primary">The "Why"</h2>
                    <p>
                ...
                <div>
                    <h2 className="font-headline text-2xl text-primary">Key Features</h2>
                ...
                <div>
                    <h2 className="font-headline text-2xl text-primary">How to Use It</h2>
                    <p>
                ...
                <div>
                     <h2 className="font-headline text-2xl text-primary">Connect With Me</h2>
                    <p>
