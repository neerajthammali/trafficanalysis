...
export const TrafficDataSchema = z.object({
  ...
  timeInterval: z.enum(['30 mins', '1 hour'], { required_error: "Please select a time interval."}),
  ...
  wrongDirection: z.string().min(3, 'Please describe instances of wrong-direction driving.'),
});
