...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an expert traffic planner. Based on the following information, suggest a list of specific infrastructure and policy development ideas to improve long-term traffic flow and safety. Include suggestions like new skywalks, road widening, signal optimization, enforcement changes, or other relevant solutions.
